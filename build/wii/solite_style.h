#ifndef SOLITE_STYLE_H
#define SOLITE_STYLE_H

/*
 * solite_style.h — CSS-like style property system for Solite/Wii.
 *
 ...
 * and applied to a SoliteGuiElement by walking the registry.
 */
...
static inline SolidStyleValue solite_style_int(int v) {
    SolidStyleValue sv;
...
static inline SolidStyleValue solite_style_float(float v) {
    SolidStyleValue sv;
...
static inline SolidStyleValue solite_style_color(uint8_t r, uint8_t g, uint8_t b, uint8_t a) {
    SolidStyleValue sv;
...
static inline SolidStyleValue solite_style_string(const char *s) {
    SolidStyleValue sv;
...
static inline SolidStyleValue solite_style_bool(bool v) {
    SolidStyleValue sv;
