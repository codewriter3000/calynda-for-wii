...
/* ------------------------------------------------------------------ */
static void test_symbol_table_import_alias(void) {
    const char *source =
...
/* ------------------------------------------------------------------ */
static void test_symbol_table_import_selective(void) {
    const char *source =
...
/* ------------------------------------------------------------------ */
static void test_symbol_table_ambiguous_selective_import(void) {
    const char *source =
...
/* ------------------------------------------------------------------ */
static void test_symbol_table_export_static_flags(void) {
    const char *source =
...
/* ------------------------------------------------------------------ */
static void test_symbol_table_internal_flag(void) {
    const char *source =
        "start(string[] args) -> {\n"
...
static void test_symbol_table_union_and_type_params(void) {
    const char *source =
...
static void test_symbol_table_union_no_generics(void) {
    const char *source =
